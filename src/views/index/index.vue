<template>
	<div>
			...
			<el-col :span="6" v-for="(item,index) in counts" :key="index">
				<el-card class="box-card" shadow="hover">
					<div class="d-flex align-items-center">
						<i :class="[item.icon,item.color]" class="border text-center h4 mb-0 mr-3 text-white" style="width: 40px;height: 40px;line-height: 40px;"></i>
						<div>
		...
		<!-- 店铺、订单提示|统计图 -->
		<el-row :gutter="20" class="mt-3" style="padding-bottom: 60px;">
			<!-- 店铺、订单提示-->
			<el-col :span="12" class="d-flex flex-column" style="height: 370px;">
				<!-- 上 -->
				<el-card class="box-card mb-auto" shadow="never" v-for="(tip,ti) in tips" :key="ti">
		...
		<el-row :gutter="20" class="my-3">
			<el-col :span="12">
				<el-card class="box-card" shadow="never">
					...
					<div class="media border my-3" style="align-items: stretch;" v-for="(sale,salei) in sales.list" :key="salei">
						<span class="py-4 px-3 bg-light border-right">
							{{sale.title}}
						</span>
						<div class="media-body">
							<div class="border-bottom pl-3 d-flex align-items-center" style="height: 50%;">
								<span>订单量(件)</span>
								{{sale.orderNum}}
							</div>
							<div class="pl-3 d-flex align-items-center" style="height: 50%;">
								<span>订单金额(元)</span>
								{{sale.orderAmount}}
							</div>
						</div>
