<template>
	<el-form ref="form" label-width="80px">
		<el-form-item label="商品名称">
			<el-input :value="title" @input="vmodel('title',$event)" class="w-50" placeholder="请输入商品名称,不能超过60个字符"></el-input>
		</el-form-item>
		<el-form-item label="商品分类">
			<el-cascader :value="category" @input="vmodel('category',$event)" :options="options"></el-cascader>
		</el-form-item>
		<el-form-item label="商品描述">
			<el-input type="textarea" :value="desc" @input="vmodel('desc',$event)" class="w-50" placeholder="请输入商品名称,不能超过60个字符"></el-input>
		</el-form-item>
		<el-form-item label="商品单位">
			<el-input :value="unit" @input="vmodel('unit',$event)" class="w-50" placeholder="请输入商品单位"></el-input>
		</el-form-item>
		<el-form-item label="总库存">
			<el-input type="number" :value="stock" @input="vmodel('stock',$event)" class="w-25" placeholder="请输入商品库存">
				<template slot="append">件</template>
			</el-input>
		</el-form-item>
		<el-form-item label="库存预警">
			<el-input type="number" :value="min_stock" @input="vmodel('min_stock',$event)" class="w-25" placeholder="请输入商品单位">
				<template slot="append">件</template>
			</el-input>
		</el-form-item>
